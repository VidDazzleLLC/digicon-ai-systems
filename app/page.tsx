              ...
              <div className="text-center">
                ...
                <div className="bg-blue-500/10 rounded-lg p-4 border border-blue-500/30 mb-6">
                  <p className="text-sm text-gray-300">
                    <span className="font-bold text-blue-400">{'🔒 100% Secure:'}</span>{' All file uploads happen in Secure Conference Rooms with military-grade AES-256-GCM encryption, SOC 2 Type II compliance, and zero third-party data sharing.'}
                  </p>
                </div>
                <button
                  onClick={() => setActiveSection('conferencerooms')}
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 backdrop-blur-lg rounded-2xl p-6 border border-blue-500/30">
                  ...
                  <div className="mt-6 bg-blue-500/10 rounded-lg p-4 border border-blue-500/30">
                    <p className="text-sm text-gray-300">
                      <span className="font-bold text-blue-400">{'Why it matters:'}</span>{' CFOs share payroll, financial, HRIS, ERP, CRM, and compliance data with complete confidence. Your sensitive data stays encrypted and private.'}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 border-2 border-blue-500/50 rounded-2xl p-8 mb-12">
              ...
              <div className="bg-blue-500/10 rounded-lg p-4 border border-blue-500/30">
                <p className="text-sm text-gray-300">
                  <span className="font-bold text-blue-400">{'📌 Note:'}</span>{' Each conference room is named after your company (e.g., "Acme Corp - Secure Conference Room") for easy identification. Your access code is emailed immediately after room creation.'}
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <button onClick={() => setShowCreateModal(true)} className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-6 py-3 rounded-lg font-bold">
