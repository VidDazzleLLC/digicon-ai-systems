      ...
      <div className="pt-16">
        ...
        {activeSection === 'home' && (
          <div className="relative">
            ...
            {/* 88
            PAYROLL AUDIT CTA - Prominent on first page view */}              <div className="mb-12 bg-gradient-to-r from-red-900/40 to-black border-2 border-red-500 rounded-2xl p-8 max-w-4xl mx-auto backdrop-blur-lg shadow-2xl shadow-red-500/50 animate-pulse">
                <div className="text-center">
